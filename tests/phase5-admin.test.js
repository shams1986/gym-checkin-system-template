...
assert.match(css, /a\.button\.primary:hover[^{]*\{[^}]*color:#fff/);
assert.match(css, /a\.button\.primary:hover[^{]*\{[^}]*border-color:#bfd0d4/);
assert.match(css, /\.identity-name strong\{font-weight:400\}/);
assert.match(css, /#personal-message-filter \.button/);
assert.match(css, /#member-filters \.button/);
...
assert.match(client, /labelControls\("schedule-filters", \{ day: "Day", status: "Session status"/);
